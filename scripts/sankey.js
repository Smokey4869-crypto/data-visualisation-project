...
function drawSankey(data) {
  ...
  let margin = { top: 10, right: 150, bottom: 10, left: 150 },
...
window.onload = function () {
  ...
  d3.select("#south-america")
    .on("click", function () {
      dataByRegion("South America")
    })

  d3.select("#oceania")
    .on("click", function () {
      dataByRegion("Oceania")
    })
